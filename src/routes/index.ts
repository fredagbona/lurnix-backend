...
import authRoutes from "../domains/auth/routes/auth/authRoutes";
import userManagementRoutes from "../domains/auth/routes/userManagementRoutes";
...
import subscriptionRoutes from "../domains/billing/routes/subscriptionRoutes";
import planRoutes from "../domains/billing/routes/planRoutes";
import pricingRoutes from "../domains/billing/routes/pricingRoutes";
import couponRoutes from "../domains/billing/routes/couponRoutes";
import webhookRoutes from "../domains/billing/routes/webhookRoutes";
import aiRoutes from "../domains/ai/routes/aiRoutes";
import aiProfileRoutes from "../domains/ai/routes/aiProfileRoutes";
